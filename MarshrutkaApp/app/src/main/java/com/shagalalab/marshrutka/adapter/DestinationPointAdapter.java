...
public class DestinationPointAdapter extends ArrayAdapter<DestinationPoint> implements Filterable {
    ...
    private List<DestinationPoint> mValues;
    private List<DestinationPoint> mOriginalValues;
    ...
    private class ArrayFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence prefix) {
            ...
            if (prefix == null || prefix.length() == 0) {
                synchronized (lock) {
                    ArrayList<DestinationPoint> list = new ArrayList<>(mOriginalValues);
                    results.values = list;
                ...
                ArrayList<DestinationPoint> newValues = new ArrayList<>(count);
